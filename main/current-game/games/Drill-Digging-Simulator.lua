-- current-game/games/Drill-Digging-Simulator.lua
return function(Tab, Aurexis, Window, ctx)
    ...
    local scripts = {
        { name = "Tora Hub", url = "https://raw.githubusercontent.com/gumanba/Scripts/main/DrillDigging" },
        { name = "ScarabHub", url = "https://raw.githubusercontent.com/scarabhub/Drill-Digging-Simulator/refs/heads/main/main.lua" },
    }
