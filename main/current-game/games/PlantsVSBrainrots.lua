...
return function(Tab, Aurexis, Window, ctx)
    ...
    local scripts = {
        { name = "Rift Hub",     url = "https://rifton.top/loader.lua",                                                             description = "Won´t work with Solara and Xeno" },
        { name = "Space Hub",    url = "https://raw.githubusercontent.com/ago106/SpaceHub/refs/heads/main/loader.lua",              keyRequired = true },
        { name = "Polluted PVB", url = "https://api.luarmor.net/files/v3/loaders/3e0e5bada3453caa36246a325f2345f3.lua",             description = "Very good and Keyless" },
        { name = "Tbao Hub",     url = "https://raw.githubusercontent.com/tbao143/thaibao/refs/heads/main/TbaoHubPlantsVsBrainrots" },
        { name = "NO LAG HUB",   url = "https://raw.githubusercontent.com/NoLag-id/No-Lag-HUB/refs/heads/main/Loader/Main.lua",     keyRequired = true },
     -- { name = "", url = "" },
