...
return function(Tab, Aurexis, Window, ctx)
    ...
    local scripts = {
        { name = "Champion 2.8X", url = "https://raw.githubusercontent.com/ZxenoLR/Champion/refs/heads/main/Loader/Loader.luau", recommended = true },
        { name = "Solaris", url = "https://raw.githubusercontent.com/toasty-dev/pissblox/main/solaris_bootstrapper.lua" },
        { name = "quotas hub", url = "https://raw.githubusercontent.com/Insertl/QuotasHub/main/BETAv1.3" },
        { name = "Vapa v2", url = "https://raw.githubusercontent.com/Nickyangtpe/Vapa-v2/refs/heads/main/Vapav2-Arsenal.lua" },
