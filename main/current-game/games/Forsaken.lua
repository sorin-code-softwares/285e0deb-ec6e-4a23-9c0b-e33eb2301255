-- current-game/games/Forsaken.lua
return function(Tab, Aurexis, Window, ctx)
    ...
    local scripts = {
        { name = "Voidware", url = "https://raw.githubusercontent.com/VapeVoidware/VW-Add/main/forsaken.lua", description = " | Good Script" },
        { name = "Mandy Hub", url = "https://raw.githubusercontent.com/MaybeNotMandy/forsaken/refs/heads/main/sae" },
        { name = "Fartsaken", url = "https://raw.githubusercontent.com/ivannetta/ShitScripts/refs/heads/main/forsaken.lua", description = "Good Script | Join DC for Key" },
    }
