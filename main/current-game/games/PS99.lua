...
return function(Tab, Aurexis, Window, ctx)
    ...
    local scripts = {
        ...
        { name = "Reaper Hub",  url = "https://you.whimper.xyz/reaperhub", recommended = true},
        { name = "project L",   url = "https://raw.githubusercontent.com/idonthaveoneatm/lua/normal/games/PetSimulator99/src"},
    }
