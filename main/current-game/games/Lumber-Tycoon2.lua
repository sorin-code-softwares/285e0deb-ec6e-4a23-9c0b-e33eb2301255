-- current-game/games/Lumber-Tycoon2.lua
...
return function(Tab, Aurexis, Window, ctx)
    ...
    local scripts = {
        { name = "KronHub", url = "https://raw.githubusercontent.com/DevKron/Kron_Hub/refs/heads/main/version_1.0" },
        { name = "DazedHub", url = "https://raw.githubusercontent.com/666TranZit666/rewrite/main/Dazed%20X", description = "🔑 Has a Key System | Don´t work with Exec like Solara" },
    }
