...
return function(Tab, Aurexis, Window, ctx)
    ...
    ----------------------------------------------------------------
    -- Chat Bypasser
    Tab:CreateSection("Chat Bypasser")
    local mainScripts = {
        { name = "Cookie Bypasser", url = "https://gist.githubusercontent.com/mert134/358b6c0b43e67f75dd4c8f1fc17af692/raw/eeeb6479868b3aaee57d8b60559e6d1aae13d17d/gistfile1.txt" },
        { name = "Cat Bypasser",  url = "https://raw.githubusercontent.com/shadow62x/catbypass/main/upfix" }
    }
